...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1846406670039692"
...
<main class="flex-shrink-0">
        ...
        if (file_exists(dirname(__FILE__).'/'.$relative.'template/WebcamQRcodescanner.php')) {
            include dirname(__FILE__).'/'.$relative.'template/WebcamQRcodescanner.php';
        }
